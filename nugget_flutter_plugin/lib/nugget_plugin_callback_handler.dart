...
class NuggetPluginNativeCallbackHandler {
  ...
  static Future<dynamic> _handleNativeMethodCall(MethodCall call) async {
    print("NuggetPlugin Callback Handler: Dart received native call: ${call.method}");
    ...
    switch (call.method) {
      case 'requireAuthInfo':
        try {
          ...
          throw PlatformException(
              ...
              message: "Error getting auth info in Dart: ${e.toString()}", // Descriptive message
      ...
      default:
        ...
        throw MissingPluginException('Method "${call.method}" not implemented on Dart side.');
    }
  }
